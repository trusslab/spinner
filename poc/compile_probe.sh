...
docker run --rm -ti -v $HOME:$HOME linux-build-x86_64 -c "dpkg -i /home/priya/s2e/images/.tmp-output/linux-6.8.2-x86_64/*.deb && cd $s2e_project_dir	&& sudo stap -a x86_64 -r 6.8.2-s2e -g -m probe probe.stp -F && cd /home/priya/defogger/poc/nmi_example && make && cp nmi_example.ko $s2e_project_dir" 
