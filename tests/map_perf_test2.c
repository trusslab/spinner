...
#include <signal.h>
#include <time.h>
#include "map_perf_test2.skel.h"
#include "map_perf_test2.h"
...
{       
        ...
        struct map_perf_test2_bpf *skel = NULL;
        struct perf_event_attr attr;
        struct bpf_link **links = NULL;
        struct array_map *array_m = NULL;
        ...
        snprintf(filename, sizeof(filename), ".output/map_perf_test2.bpf.o");
        ...
        /*
        pb_opts.sample_period = 100;
        pb_opts.sz = 8;
        pb = perf_buffer__new(bpf_object__find_map_fd_by_name(obj,"pb"), 8, handle_event, lost>
        ...
        */
        ...
        prog = bpf_object__find_program_by_name(obj, "map_perf_test");
                //printf("%s", prog->name);
                if (!prog) {
...
cleanup:
        ...
        map_perf_test2_bpf__destroy(skel);
        free(online_mask);
        return -err;
}
